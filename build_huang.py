...
.article a:hover{background:linear-gradient(to bottom,transparent 40%,rgba(0,151,167,.2) 40%)}
...
.footer-promo::before{
  ...
  border-radius:50%;
  background:radial-gradient(circle,rgba(0,151,167,.15),transparent 70%);
}
